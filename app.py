...
# app.layout = html.Div(
#     style={
#         'backgroundImage': 'url(https://www.nasa.gov/sites/default/files/thumbnails/image/edu_what_is_the_milky_way.jpg)',
...
#                 html.Div(
#                     children=[
#                         html.Div(children='Ascension angle', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='alpha',
#                             min=0,
#                             max=360,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Declination angle', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='delta',
#                             min=0,
#                             max=360,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Ultraviolet', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='u',
#                             min=0,
#                             max=30,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Green', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='g',
#                             min=0,
#                             max=30,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Red', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='r',
#                             min=0,
#                             max=30,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Infrared (I)', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='i',
#                             min=0,
#                             max=30,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Infrared (Z)', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='z',
#                             min=0,
#                             max=30,
...
#                             tooltip={"placement": "bottom", "always_visible": True}
#                         ),
#                         html.Div(children='Redshift', style={'fontSize': 18}),
#                         dcc.Slider(
#                             id='redshift',
#                             min=0,
#                             max=10,
...
#         html.Br(),
#         html.Div(
#             [html.P(children='Stellar Classification')],
#             style={
#                 'textAlign': 'center',
#                 'backgroundColor': 'rgba(0, 0, 0, 0.6)',
#                 'padding': '10px',
